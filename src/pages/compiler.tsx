  ...
  return (
    <DefaultLayout>
      <Helmet>
        ...
        <meta
          content="Prova il compilatore JavaScript online: scrivi, esegui e testa il tuo codice JS direttamente nel browser. Ideale per snippet rapidi, debug e apprendimento | Alessandro Guelpa"
          name="description"
        />
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-4 pt-8 pb-20 md:pt-12 md:pb-32 flex flex-col items-center">
        ...
        <div className="w-full bg-white/50 dark:bg-zinc-900/50 backdrop-blur-md border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 shadow-xl">
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200" />
            <textarea
